...
shipsignal is currently in pre-release development (v0.x). All versions receive security updates.
...
We take security issues seriously. If you discover a vulnerability in shipsignal, please report it responsibly using one of the following methods:

1. **Email**: Send a report to security@shipsignal.to
...
- The shipsignal web application (https://shipsignal.to)
...
- Social engineering attacks against shipsignal users or team members
- Denial-of-service attacks
- Vulnerabilities in dependencies that have already been publicly disclosed and have available patches

## Safe Harbor

shipsignal supports responsible security research. We will not pursue legal action against individuals who:
...
For security-related inquiries, reach out to security@shipsignal.to.
